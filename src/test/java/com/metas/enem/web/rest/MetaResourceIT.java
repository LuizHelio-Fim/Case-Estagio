...
import static com.metas.enem.domain.MetaAsserts.*;
import static com.metas.enem.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.metas.enem.IntegrationTest;
import com.metas.enem.domain.Meta;
import com.metas.enem.repository.MetaRepository;
import com.metas.enem.service.MetaService;
import com.metas.enem.service.dto.MetaDTO;
import com.metas.enem.service.mapper.MetaMapper;
...
class MetaResourceIT {
    ...
    private static final Integer DEFAULT_LINGUAGEM = 1000;
    private static final Integer UPDATED_LINGUAGEM = 999;

    private static final Integer DEFAULT_HUMANAS = 1000;
    private static final Integer UPDATED_HUMANAS = 999;

    private static final Integer DEFAULT_NATUREZA = 1000;
    private static final Integer UPDATED_NATUREZA = 999;

    private static final Integer DEFAULT_MATEMATICA = 1000;
    private static final Integer UPDATED_MATEMATICA = 999;
