...
import com.metas.enem.service.AlunoService;
...
/**
 * REST controller for managing {@link com.metas.enem.domain.Aluno}.
 */
@RestController
...
public class AlunoResource {
    ...
    public ResponseEntity<List<AlunoDTO>> getAllAlunos(
        ...
        if ("meta-is-null".equals(filter)) {
            LOG.debug("REST request to get all Alunos where meta is null");
            return new ResponseEntity<>(alunoService.findAllWhereMetaIsNull(), HttpStatus.OK);
        }
