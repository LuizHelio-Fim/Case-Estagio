...
export class MetaUpdateComponent implements OnInit {
  ...
  protected updateForm(meta: IMeta): void {
    ...
    this.alunosCollection = this.alunoService.addAlunoToCollectionIfMissing<IAluno>(this.alunosCollection, meta.aluno);
  }

  protected loadRelationshipsOptions(): void {
    this.alunoService
      .query({ filter: 'meta-is-null' })
      ...
      .subscribe((alunos: IAluno[]) => (this.alunosCollection = alunos));
  }
}
