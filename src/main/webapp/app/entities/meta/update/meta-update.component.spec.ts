...
describe('Meta Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('should call aluno query and add missing value', () => {
      ...
      const expectedCollection: IAluno[] = [aluno, ...alunoCollection];
      ...
      expect(alunoService.addAlunoToCollectionIfMissing).toHaveBeenCalledWith(alunoCollection, aluno);
      expect(comp.alunosCollection).toEqual(expectedCollection);
    });
    ...
    it('should update editForm', () => {
      ...
      expect(comp.alunosCollection).toContainEqual(aluno);
